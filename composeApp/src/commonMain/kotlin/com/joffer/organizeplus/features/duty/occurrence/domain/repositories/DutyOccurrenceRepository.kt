...
interface DutyOccurrenceRepository {
    ...
    suspend fun getDutyOccurrencesByDutyId(dutyId: Long): Result<List<DutyOccurrence>>
    suspend fun getLastOccurrenceByDutyId(dutyId: Long): Result<DutyOccurrence?>
    ...
    suspend fun deleteDutyOccurrence(id: Long): Result<Unit>
}
